...
public class ListItem {
	...
	private String removeNGwordForTitle(String title) {
		title = replaceAll(title, "オリジナル曲", "");
		title = replaceAll(title, "オリジナル", "");
		title = replaceAll(title, "ニコカラ", "");
	...
	private String removeNGwordForArtist(String artist) {
		artist = replaceAll(artist, "オリジナル曲", "");
		artist = replaceAll(artist, "オリジナル", "");
		artist = replaceAll(artist, "ニコカラ", "");
